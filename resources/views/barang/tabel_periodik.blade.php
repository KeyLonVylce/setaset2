...
.badge-tambah { background: #dcfce7; color: #166534; }
...
.ket-row { display: none; }
.ket-row.open { display: table-row; }
.ket-cell {
    background: #f8faff;
...
.ket-bubble b { color: #1e40af; }
.ket-bubble i { color: #6b7280; }

/* Ruangan disabled state */
#ruanganSelect:disabled {
    opacity: 0.5;
    cursor: not-allowed;
    background: #f3f4f6;
}
